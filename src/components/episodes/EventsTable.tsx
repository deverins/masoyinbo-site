...
const EventsTable: React.FC<EpisodeEvents> = ({ events }) => {
            ...
            >
              ...
              {isAdmin && (
                <div className="flex gap-2 w-[140px] justify-center">
                  <button onClick={handleEdit} className="bg-blue-500 text-white hover:bg-blue-600 p-1 rounded">
                    <PencilIcon className="h-5 w-5" />
                  </button>
                  <button onClick={handleDelete} className="bg-red-500 text-white hover:bg-red-600 p-1 rounded">
