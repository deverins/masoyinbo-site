...
const EpisodePage: React.FC = () => {
  ...
  return (
    <>
      {episodeDetails ? (
        <>
          <div className="sticky top-[75px] h-auto z-10 bg-slate-200 dark:bg-slate-900">
            <div className="flex flex-col items-center py-4">
              <div className="mx-auto w-full max-w-screen-sm sm:mx-20">
                <VideoPreview
                  videoLink={episodeDetails.episode.episodeLink}
                  title=""
                />
              </div>
              ...
              <div className="mt-4 w-full max-w-[560px]">
                ...
                <div className="dark:text-neutral-300 font-semibold">
                  ...
                  {formatCurrency(episodeDetails.episode.availableAmountToWin)}
                </div>
          ...
          <h3 className="text-center font-bold text-xl dark:text-neutral-200 mt-6">
            Episode Events
          </h3>
          {isAdmin && (
            ...
            <div className="p-4 w-[calc(100dvw-12px)] max-w-[600px]">
              ...
              <div className="mt-4 flex justify-end">
                <button
                  ...
                  className="mr-2 bg-gray-300 hover:bg-gray-400 p-2 rounded"
                >
                  Cancel
                </button>
                <button
